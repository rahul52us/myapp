...
import { ForgotValidation } from '../../../config/utils/validation/validation';
        ...
        {({ values, errors, handleChange, handleBlur, handleSubmit, isSubmitting }) => (
          <form onSubmit={handleSubmit}>
            ...
            <Grid item xl={12} xs={12} md={12} sm={12} xxl={12}>
              ...
              >
                <Grid item>
                  <Link to={authRoute.REGISTER}>Create an Account</Link>
                </Grid>
                <Grid item>
...
const LoginMainContainer = styled.div`
  ...
  margin-top: ${(props) => (props.isLgDown ? '1rem' : '25vh')};
`;
