...
export const StudentEditValidation = Yup.object({
  username: Yup.string()
  ...
  medium: Yup.object().required('please select the medium').typeError('please select the medium'),
...
export const StudentCreateValidation = Yup.object({
  username: Yup.string()
    .min(4, 'user name should be minimum of 4 word')
    .max(80, 'user name should not be greature than 80 word')
    .required('user name is required')
